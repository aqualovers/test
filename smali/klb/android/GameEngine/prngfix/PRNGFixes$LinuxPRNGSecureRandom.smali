...
.method private getUrandomInputStream()Ljava/io/DataInputStream;
    ...
    .prologue
    .line 249
    sget-object v2, Lklb/android/GameEngine/prngfix/PRNGFixes$LinuxPRNGSecureRandom;->sLock:Ljava/lang/Object;
...
.method protected engineGenerateSeed(I)[B
    ...
    .line 244
    .local v0, "seed":[B
    invoke-virtual {p0, v0}, Lklb/android/GameEngine/prngfix/PRNGFixes$LinuxPRNGSecureRandom;->engineNextBytes([B)V
...
.method protected engineNextBytes([B)V
    ...
    .prologue
    .line 221
    iget-boolean v2, p0, Lklb/android/GameEngine/prngfix/PRNGFixes$LinuxPRNGSecureRandom;->mSeeded:Z

    if-nez v2, :cond_0

    .line 223
    # invokes: Lklb/android/GameEngine/prngfix/PRNGFixes;->generateSeed()[B
    invoke-static {}, Lklb/android/GameEngine/prngfix/PRNGFixes;->access$000()[B

    move-result-object v2

    invoke-virtual {p0, v2}, Lklb/android/GameEngine/prngfix/PRNGFixes$LinuxPRNGSecureRandom;->engineSetSeed([B)V

    .line 228
    :cond_0
    :try_start_0
    sget-object v3, Lklb/android/GameEngine/prngfix/PRNGFixes$LinuxPRNGSecureRandom;->sLock:Ljava/lang/Object;
...
.method protected engineSetSeed([B)V
    ...
    iput-boolean v2, p0, Lklb/android/GameEngine/prngfix/PRNGFixes$LinuxPRNGSecureRandom;->mSeeded:Z
    :try_end_2
    .catch Ljava/io/IOException; {:try_start_2 .. :try_end_2} :catch_0
